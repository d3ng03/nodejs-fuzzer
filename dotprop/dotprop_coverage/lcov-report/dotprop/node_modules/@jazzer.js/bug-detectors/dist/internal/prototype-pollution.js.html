...
<head>
    <title>Code coverage report for dotprop/node_modules/@jazzer.js/bug-detectors/dist/internal/prototype-pollution.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../../../index.html">All files</a> / <a href="index.html">dotprop/node_modules/@jazzer.js/bug-detectors/dist/internal</a> prototype-pollution.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">39.28% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>44/112</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>40/104</span>
            </div>
...
class PrototypePollutionConfig {
     ...
     */
<span class="fstat-no" title="function not covered" >    ad</span>dExcludedExactMatch(protoValue) {
<span class="cstat-no" title="statement not covered" >        this._excludedExactMatches.push(protoValue);</span>
<span class="cstat-no" title="statement not covered" >        return this;</span>
     ...
     * ```
     */
<span class="fstat-no" title="function not covered" >    in</span>strumentAssignmentsAndVariableDeclarations() {
<span class="cstat-no" title="statement not covered" >        if (global.options.dryRun) {</span>
...
<span class="cstat-no" title="statement not covered" >        this._instrumentAssignments = true;</span>
<span class="cstat-no" title="statement not covered" >        return this;</span>
    }
<span class="fstat-no" title="function not covered" >    ge</span>tExcludedExactMatches() {
<span class="cstat-no" title="statement not covered" >        return this._excludedExactMatches;</span>
    }
...
(0, core_2.registerInstrumentationPlugin)(() =&gt; {
    function <span class="fstat-no" title="function not covered" >getIdentifierFromAssignmentExpression(</span>expr) {
<span class="cstat-no" title="statement not covered" >        if (core_1.types.isIdentifier(expr.left)) {</span>
<span class="cstat-no" title="statement not covered" >            return expr.left;</span>
        }
<span class="cstat-no" title="statement not covered" >        return skipMemberExpressions(expr.left);</span>
    }
    function <span class="fstat-no" title="function not covered" >skipMemberExpressions(</span>expr) {
<span class="cstat-no" title="statement not covered" >        if (core_1.types.isIdentifier(expr)) {</span>
<span class="cstat-no" title="statement not covered" >            return expr;</span>
        }
        else <span class="cstat-no" title="statement not covered" >if (core_1.types.isMemberExpression(expr) &amp;&amp; expr.object) {</span>
<span class="cstat-no" title="statement not covered" >            return skipMemberExpressions(expr.object);</span>
        }
    }
    return {
...
<span class="cstat-no" title="statement not covered" >                if (core_2.instrumentationGuard.has("AssignmentExpression", path.node)) {</span>
<span class="cstat-no" title="statement not covered" >                    return;</span>
                }
                // Get identifier of the variable being assigned to
                const identifier = <span class="cstat-no" title="statement not covered" >getIdentifierFromAssignmentExpression(path.node);</span>
...
<span class="cstat-no" title="statement not covered" >                    return;</span>
                ...
                const originalAssignment = <span class="cstat-no" title="statement not covered" >JSON.parse(JSON.stringify(path.node));</span>
                // Add the original assignment to the instrumentation guard to avoid its re-instrumentation.
<span class="cstat-no" title="statement not covered" >                core_2.instrumentationGuard.add("AssignmentExpression", originalAssignment);</span>
<span class="cstat-no" title="statement not covered" >                path.replaceWith(core_1.types.callExpression(core_1.types.arrowFunctionExpression([path.scope.generateUidIdentifier("unused")], core_1.types.blockStatement([</span>
...
<span class="cstat-no" title="statement not covered" >                if (path.node.init) {</span>
<span class="cstat-no" title="statement not covered" >                    if (core_2.instrumentationGuard.has("VariableDeclaration", path.node)) {</span>
<span class="cstat-no" title="statement not covered" >                        return;</span>
                    }
                    const variableName = <span class="cstat-no" title="statement not covered" >path.node.id.name;</span>
                    const newVariable = <span class="cstat-no" title="statement not covered" >path.scope.generateUidIdentifier("jazzerPP_" + variableName);</span>
<span class="cstat-no" title="statement not covered" >                    if (core_1.types.isAssignmentExpression(path.node.init))</span>
<span class="cstat-no" title="statement not covered" >                        core_2.instrumentationGuard.add("AssignmentExpression", path.node.init);</span>
<span class="cstat-no" title="statement not covered" >                    path.node.init = core_1.types.callExpression(core_1.types.arrowFunctionExpression([newVariable], core_1.types.blockStatement([</span>
...
<span class="cstat-no" title="statement not covered" >                    core_2.instrumentationGuard.add("VariableDeclaration", path.node.init);</span>
                }
            },
        },
    };
...
(0, core_2.registerAfterEachCallback)(function detectPrototypePollutionOfBasicObjects() {
    ...
    for (let i = 0; i &lt; BASIC_PROTO_SNAPSHOTS.length; i++) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!currentProtoSnapshots[i]) {
<span class="cstat-no" title="statement not covered" >            (0, core_2.reportFinding)(`Prototype Pollution: Prototype of ${BASIC_OBJECT_NAMES[i]} changed.`);</span>
<span class="cstat-no" title="statement not covered" >            return;</span>
        }
        const equalityResult = protoSnapshotsEqual(BASIC_PROTO_SNAPSHOTS[i], currentProtoSnapshots[i]);
        <span class="missing-if-branch" title="if path not taken" >I</span>if (equalityResult) {
<span class="cstat-no" title="statement not covered" >            (0, core_2.reportFinding)(`Prototype Pollution: Prototype of ${BASIC_OBJECT_NAMES[i]} changed. ${equalityResult}`);</span>
<span class="cstat-no" title="statement not covered" >            return;</span>
        }
    }
});
 ...
 */
function <span class="fstat-no" title="function not covered" >detectPrototypePollution(</span>
// eslint-disable-next-line  @typescript-eslint/no-explicit-any
obj, identifier, report = <span class="branch-0 cbranch-no" title="branch not covered" >true)</span> {
<span class="cstat-no" title="statement not covered" >    while (obj !== undefined &amp;&amp; obj !== null) {</span>
<span class="cstat-no" title="statement not covered" >        try {</span>
            // JSON.stringify will ignore function properties.
            const protoValue = <span class="cstat-no" title="statement not covered" >JSON.stringify(Object.getPrototypeOf(obj));</span>
<span class="cstat-no" title="statement not covered" >            if (protoValue &amp;&amp;</span>
                !(protoValue === "null" ||
                    protoValue === "{}" ||
                    protoValue === "[]" ||
                    protoValue === '""' ||
                ...
                let message;
<span class="cstat-no" title="statement not covered" >                if (identifier) {</span>
<span class="cstat-no" title="statement not covered" >                    message = `Prototype Pollution: ${identifier}.__proto__ value is ${protoValue}`;</span>
                }
                else {
<span class="cstat-no" title="statement not covered" >                    message = `Prototype Pollution: __proto__ value is ${protoValue}`;</span>
                }
<span class="cstat-no" title="statement not covered" >                if (report) {</span>
<span class="cstat-no" title="statement not covered" >                    (0, core_2.reportFinding)(message);</span>
                }
...
function protoSnapshotsEqual(snapshot1, snapshot2) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (snapshot1.prototype !== snapshot2.prototype) {
<span class="cstat-no" title="statement not covered" >        return `Different [[Prototype]]: ${snapshot1.prototype} vs ${snapshot2.prototype}`;</span>
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (snapshot1.propertyNames.length !== snapshot2.propertyNames.length) {
        const printNamesAndValues = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >(n</span>ames, values) =&gt; {</span>
            const namesAndValues = <span class="cstat-no" title="statement not covered" >names</span>
                .map(<span class="fstat-no" title="function not covered" >(n</span>ame, index) =&gt; <span class="cstat-no" title="statement not covered" >`'${name}': ${values[index]}`)</span>
                .join(", ");
<span class="cstat-no" title="statement not covered" >            return "{ " + namesAndValues + " }";</span>
        };
        ...
        const complement1 = <span class="cstat-no" title="statement not covered" >snapshot1.propertyNames.filter(<span class="fstat-no" title="function not covered" >(x</span>) =&gt; <span class="cstat-no" title="statement not covered" >!snapshot2.propertyNames.includes(x))</span>;</span>
        const complement2 = <span class="cstat-no" title="statement not covered" >snapshot2.propertyNames.filter(<span class="fstat-no" title="function not covered" >(x</span>) =&gt; <span class="cstat-no" title="statement not covered" >!snapshot1.propertyNames.includes(x))</span>;</span>
        // Get corresponding snapshot1.propertyValues
        const complement1Values = <span class="cstat-no" title="statement not covered" >complement1.map(<span class="fstat-no" title="function not covered" >(n</span>ame) =&gt; <span class="cstat-no" title="statement not covered" >snapshot1.propertyValues[snapshot1.propertyNames.indexOf(name)])</span>;</span>
        const complement2Values = <span class="cstat-no" title="statement not covered" >complement2.map(<span class="fstat-no" title="function not covered" >(n</span>ame) =&gt; <span class="cstat-no" title="statement not covered" >snapshot2.propertyValues[snapshot2.propertyNames.indexOf(name)])</span>;</span>
        let message = <span class="cstat-no" title="statement not covered" >"";</span>
<span class="cstat-no" title="statement not covered" >        if (complement1.length &gt; 0) {</span>
...
<span class="cstat-no" title="statement not covered" >        if (complement2.length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >            message +=</span>
...
<span class="cstat-no" title="statement not covered" >        return message;</span>
    ...
    for (let propertyId = 0; propertyId &lt; snapshot1.propertyNames.length; propertyId++) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (snapshot1.propertyNames[propertyId] !==
            snapshot2.propertyNames[propertyId]) {
<span class="cstat-no" title="statement not covered" >            return `Different or rearranged property names: ${snapshot1.propertyNames[propertyId]} vs. ${snapshot2.propertyNames[propertyId]}`;</span>
        }
    }
    ...
    for (let propertyId = 0; propertyId &lt; snapshot1.propertyValues.length; propertyId++) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (snapshot1.propertyValues[propertyId] !==
            snapshot2.propertyValues[propertyId]) {
<span class="cstat-no" title="statement not covered" >            return `Different properties: ${snapshot1.propertyNames[propertyId]}: ${snapshot1.propertyValues[propertyId]} vs. </span>
${snapshot2.propertyNames[propertyId]}: ${snapshot2.propertyValues[propertyId]}`;
        }
    }
}
//# sourceMappingURL=prototype-pollution.js.map</pre></td></tr></table></pre>
