...
<head>
    <title>Code coverage report for dotprop/node_modules/@jazzer.js/bug-detectors/dist/internal/path-traversal.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../../../index.html">All files</a> / <a href="index.html">dotprop/node_modules/@jazzer.js/bug-detectors/dist/internal</a> path-traversal.js</h1>
        <div class='clearfix'>
...
for (const module of modulesToHook) {
    for (const functionName of module.functionNames) {
        const beforeHook = (thisPtr, params, hookId) =&gt; {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (params === undefined || params.length === 0) {
<span class="cstat-no" title="statement not covered" >                return;</span>
            }
            // The first argument of the original function is typically
            // a path or a file name.
            const firstArgument = params[0];
            <span class="missing-if-branch" title="if path not taken" >I</span>if (firstArgument.includes(goal)) {
<span class="cstat-no" title="statement not covered" >                (0, core_1.reportFinding)(`Path Traversal in ${functionName}(): called with '${firstArgument}'`);</span>
            }
...
for (const module of functionsWithTwoTargets) {
    for (const functionName of module.functionNames) {
        const makeBeforeHook = (extraHookId) =&gt; {
            return <span class="fstat-no" title="function not covered" >(t</span>hisPtr, params, hookId) =&gt; {
<span class="cstat-no" title="statement not covered" >                if (params === undefined || params.length &lt; 2) {</span>
<span class="cstat-no" title="statement not covered" >                    return;</span>
                }
                // The first two arguments are paths.
                const firstArgument = <span class="cstat-no" title="statement not covered" >params[0];</span>
                const secondArgument = <span class="cstat-no" title="statement not covered" >params[1];</span>
<span class="cstat-no" title="statement not covered" >                if (firstArgument.includes(goal) || secondArgument.includes(goal)) {</span>
<span class="cstat-no" title="statement not covered" >                    (0, core_1.reportFinding)(`Path Traversal in ${functionName}(): called with '${firstArgument}'` +</span>
                        ` and '${secondArgument}'`);
                }
<span class="cstat-no" title="statement not covered" >                (0, core_1.guideTowardsContainment)(firstArgument, goal, hookId);</span>
...
<span class="cstat-no" title="statement not covered" >                (0, core_1.guideTowardsContainment)(secondArgument, goal, extraHookId);</span>
            };
        };
...
//# sourceMappingURL=path-traversal.js.map</pre></td></tr></table></pre>
